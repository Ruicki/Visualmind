                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                                {cartItems.map((item) => (
                                    <div key={item.variantUniqueId} style={{ display: 'flex', gap: '1.5rem' }}>
                                        <div style={{ width: '100px', height: '100px', borderRadius: '12px', overflow: 'hidden', border: '1px solid var(--border-light)' }}>
                                        ...
                                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                                            ...
                                            <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '1rem' }}>${item.price}</p>
                    ...
                    {cartItems.length > 0 && (
                        <div style={{ padding: '2rem', borderTop: '1px solid var(--border-light)', background: 'var(--bg-secondary)' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                                ...
                                <span style={{ fontSize: '1.25rem', fontWeight: '800' }}>${getCartTotal()}</span>
                            </div>
                            <button
