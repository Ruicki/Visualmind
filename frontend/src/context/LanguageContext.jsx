...
export const translations = {
    en: {
        ...
        home_extended: {
            ...
            limited_stock: 'LIMITED STOCK',
              ...
              upcoming_title: 'Upcoming Drops',
              upcoming_desc: 'Reserve your spot. Be the first to own these exclusive pieces before they launch.',
              pre_order_badge: 'Pre-Order Now',
              pre_order_btn: 'Reserve Now',
            ...
            subscribe: 'Subscribe',
            no_seasonal_drops: 'No special active drops at the moment.',
            editorial_title: 'More than clothing, it\'s a statement.',
            cotton_title: '100% Cotton',
            cotton_desc: 'Maximum comfort and durability in every garment.',
            eco_title: 'Eco-Friendly',
            eco_desc: 'Committed to responsible production processes.',
            catalog_title: 'Explore the Catalog',
            view_all: 'View All',
            view_collection: 'View Collection',
            newsletter_title: 'Join the Elite',
            newsletter_desc: 'Subscribe for early access to new drops, limited editions and exclusive offers.',
            newsletter_btn: 'Subscribe',
            newsletter_sending: 'Sending...',
            newsletter_success: 'Subscription successful! You will soon receive news.',
            newsletter_already: 'You are already subscribed.',
            newsletter_error: 'Subscription error. Try again.',
            loading_products: 'Loading products...',
            catalog_empty: 'No products available at the moment.',
        },
        shop_extended: {
        ...
        admin: {
            ...
            label_lifecycle: 'Product State',
            state_draft: 'Draft',
            state_published: 'Published',
            state_legacy: 'Legacy / Archive',
            label_priority: 'Display Priority (1-100)',
            label_campaign: 'Associated Campaign',
            tooltip_hero: 'Format: 1920x800. Ratio 2.4:1. Ideal for tactical banners.',
            ...
            items_sold: 'sold',
            no_sales: 'No sales records yet',
            view_all: 'View All',
            stock_units: 'in stock',
        ...
        common: {
            ...
            trust_badge: 'Trusted by 5000+ customers',
            financial: {
                subtotal: 'Subtotal',
                shipping: 'Shipping',
                tax: 'Calculated Tax',
        ...
        policies: {
            ...
            security_text: 'At Visualmind, customer security is our number one priority. We use state-of-the-art encryption technology to protect every transaction.',
    ...
    es: {
        ...
        shop_ui: {
            ...
            filter_size: 'TALLAS',
            filter_color: 'COLORES',
            filter_price: 'RANGO DE PRECIO',
            cat_action: 'VER COLECCIÓN',
            showing_results: 'Mostrando {count} productos',
        ...
        policies: {
            commitment: 'Compromiso de Seguridad',
            security_text: 'En Visualmind, la seguridad de nuestros clientes es la prioridad número uno. Utilizamos tecnología de cifrado de última generación para proteger cada transacción.',
        ...
        home_extended: {
            ...
            limited_stock: 'STOCK LIMITADO',
              ...
              upcoming_title: 'Próximos Lanzamientos',
              upcoming_desc: 'Reserva tu lugar. Sé el primero en tener estas piezas exclusivas antes de su lanzamiento.',
              pre_order_badge: 'Reserva Ya',
              pre_order_btn: 'Reservar Ya',
              exclusive_collection: 'Colección Exclusiva',
            ...
            no_seasonal_drops: 'No hay colecciones especiales activas en este momento.',
            editorial_title: 'Más que ropa, es una declaración.',
            cotton_title: '100% Algodón',
            cotton_desc: 'Máxima comodidad y durabilidad en cada prenda.',
            eco_title: 'Eco-Friendly',
            eco_desc: 'Comprometidos con procesos de producción responsables.',
            catalog_title: 'Explora el Catálogo',
            view_all: 'Ver Todo',
            view_collection: 'Ver Colección',
            newsletter_title: 'Únete a la Élite',
            newsletter_desc: 'Suscríbete para recibir acceso anticipado a nuevos drops, ediciones limitadas y ofertas exclusivas.',
            newsletter_btn: 'Suscribirme',
            newsletter_sending: 'Enviando...',
            newsletter_success: '¡Suscripción exitosa! Pronto recibirás novedades.',
            newsletter_already: 'Ya estás suscrito.',
            newsletter_error: 'Error al suscribir. Intenta de nuevo.',
            loading_products: 'Cargando productos...',
            catalog_empty: 'No hay productos disponibles en este momento.',
        },
        shop_extended: {
        ...
        admin: {
            ...
            label_lifecycle: 'Estado del Producto',
            state_draft: 'Borrador',
            state_published: 'Publicado',
            state_legacy: 'Legado / Archivo',
            label_priority: 'Prioridad de Visualización (1-100)',
            label_campaign: 'Campaña Asociada',
            tooltip_hero: 'Formato: 1920x800. Ratio 2.4:1. Ideal para banners tácticos.',
            ...
            items_sold: 'vendidos',
            no_sales: 'Sin registros de ventas aún',
            view_all: 'Ver Todos',
            stock_units: 'en stock',
        ...
        common: {
            ...
            chat_us: 'Chatea con nosotros',
            trust_badge: 'Confianza de 5000+ clientes',
            financial: {
                subtotal: 'Subtotal',
                shipping: 'Envío',
