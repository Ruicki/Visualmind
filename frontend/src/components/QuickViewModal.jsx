...
export default function QuickViewModal({ product, isOpen, onClose }) {
    ...
    // Calculamos la imagen a mostrar base en el color seleccionado o la imagen principal del producto
    const displayImage = selectedColor?.image || getProductImage(product.image, product.image_url);
